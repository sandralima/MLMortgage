...
def get_h5_data(PRO_DIR, architecture, train_dir, valid_dir, test_dir, train_period=None, valid_period=None, test_period=None):
    try:              
        return bd.get_h5_bdataset(PRO_DIR, architecture, train_dir, valid_dir, test_dir, train_period=train_period, valid_period=valid_period, test_period=test_period)
